...
{
	$sql=mysqli_query($con,"select * from user where email_id='$_POST[username]' and password='$_POST[password]'");
                    ...
                    <div class="panel-body">
                        <form action="" method="post" id="loginForm">
                            <div class="form-group">
                                ...
                                <input type="email" placeholder="example@gmail.com" title="Please enter your username" required="" value="" name="username" id="username" class="form-control">
							...
							<div class="checkbox login-checkbox">
                                <a href="password-recovery.php">Reset Password?</a>
                            </div>

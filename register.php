...
if(isset($_POST['submit']))
{
	...
	{
		$sql=mysqli_query($con,"insert into user values('','$_POST[email]','$_POST[password]','$_POST[fname]','$_POST[lname]','$_POST[mobile]')");
		if($sql)
		{
	...
	{
		echo "<script> alert('Repeat Password Not Match with Original Password!'); </script>";
	}
}
?>
<!doctype html>
                    ...
                    <div class="panel-body">
                        <form action="" method="post" id="loginForm">
                            ...
                            <div class="text-center">
								<input type="submit" name="submit" value="Register" class="btn btn-success loginbtn" />
